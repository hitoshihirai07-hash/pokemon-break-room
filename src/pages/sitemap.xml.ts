...
export const GET: APIRoute = async () => {
  ...
  const staticPaths = ['/', '/posts/', '/about/', '/advertising/', '/disclaimer/', '/privacy/', '/categories/favorite/', '/categories/memories/', '/categories/battle/', '/categories/chat/', '/categories/lounge/'];
